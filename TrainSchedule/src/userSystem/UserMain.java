...
public class UserMain implements IsearchRides {
	...
	public static void main(String[] args) throws Exception {
		...
		if (!isHtml) {
			...
			// Logo
			System.out.println(
					"<a href=\"https://github.com/OrAmram100/TrainSchedule\"><h1 style=\"text-align: center;\"><span style=\"text-decoration: underline;\"><span style=\"color: #0000ff;\"><strong>Rail-Way Israel</strong></span></span></h1></a>");
			// Search
			...
			System.out.println(
					"<table class=\"editorDemoTable\" style=\"border-collapse: collapse; background:transparent; width: 1000px;\" align=\"center\" cellspacing=\"5\"\">"
							...
							+ "<form action=\"{{ url_for(/rail) }}\" method=\"post\">" + // Correct PATH of Python code
																							// = working code
